...
- [profile] My Profile page — avatar upload/remove, inline profile edit, own items list with edit/delete, incoming reservations with cancel, outgoing reservations with seller contact actions
- [profile] AvatarUpload component — compress + upload to Supabase Storage, remove support
- [profile] ProfileForm component — inline edit for profile fields
...
- [profiles] Public profile page (`/profiles/[id]`) — avatar, name, and list of available items
...
- [auth] Signup page (`/signup`) built in early iteration with more required fields than the current runtime
...
- [auth] User metadata passed to Supabase on signup in the historical Supabase implementation
